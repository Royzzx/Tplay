import os, shlex, time, ffmpeg, json, base64, math, re
...
if iswin == "0":
    ...
    yt_dlp = dirPath + "/binaries/yt-dlp"

    os.system(f"chmod 777 {aria2c} {mp4decrpyt} {yt_dlp}")
else:
    aria2c = dirPath + "/binaries/aria2c/exe"
    mp4decrpyt = dirPath + "/binaries/mp4decrypt.exe"
    yt_dlp = dirPath + "/binaries/yt-dlp.exe"
