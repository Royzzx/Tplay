...
from utils import aria2c, mp4decrpyt, yt_dlp
...
def trim_video_handler(app, message):
    if message.reply_to_message and message.reply_to_message.video:
        ...
        # if len(command)  2:
        #     message.reply_text("<b>Invalid command format. Please use</b>\n<code>/trim {start} {end}</code>")
        #     return
        ...
        trimmed_video_path = f'{req_file_name}{message.reply_to_message.caption.split("]")[-1].strip()}'
